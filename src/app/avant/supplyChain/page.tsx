                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-6 md:gap-10">
                        ...
                        <div className="w-full md:w-[90%] lg:w-[450px] relative h-64 sm:h-80 md:h-96 rounded-lg overflow-hidden">
                            <Image
                                ...
                                alt="Avant Pharma Supply Chain Network"
                                width={500}
                                height={600}
                        ...
                        <div className="w-full lg:w-[600px] mt-6 lg:mt-0">
                            ...
                            <div className="text-gray-600 space-y-4 text-sm sm:text-base">
                                <p>
                                    ...
                                    safely & timely reach the hands of customers.
                                </p>
                                <p>
                                    Avant Pharma is proud to have established its well-linked supply
                                    chain, which has always proved to be its major strength.
                                    Today, Avant Pharma has a strong presence in all the provinces,
                                    nooks, and corners of Pakistan through the arteries of
                    ...
                    <div className="mt-4 sm:mt-10">
                        <div className="text-gray-600 space-y-4 text-sm sm:text-base">
                            <p>
                                ...
                                a smooth supply chain system, Avant Pharma has always
                                focused on developing a chain of functioning units, which
                                pass through procurement, warehousing, operations, and
                                distribution networks, with speed, accuracy, and value
                                for money.
                            </p>
                            <p>
                                With the strength of our vigorous supply chain,
                                we foresee radiant prospects to enter newer and bigger
                                markets, making our presence felt in the wide sphere of
