                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-6 md:gap-10">
                        ...
                        <div className="w-full md:w-[90%] lg:w-[450px] relative h-64 sm:h-80 md:h-96 rounded-lg overflow-hidden">
                            <Image
                                ...
                                alt="Avant Pharma Research & Development"
                                width={500}
                                height={600}
                        ...
                        <div className="w-full lg:w-[600px] mt-6 lg:mt-0">
                            ...
                            <div className="text-gray-600 space-y-3 text-sm sm:text-base">
                                <p>
                                    ...
                                    of pharmaceuticals industry. In AVANT PHARMA we are mindful
                                    of the importance of this sector; hence established a state of
                                    art R&D wing within our corporate boundaries. Avant Pharma{"'"}s
                                    R&D Wing stands as the most important aspect of its business
                                    model; which receives constant and consistent attention and
                                    review of the corporate leadership.
                                </p>
                                <p>
                                    Resultantly; Avant Pharma{"'"}s R&D force has shown splendid results through the best
                                    utilization technological and other resources.
                                </p>
                                <p>
                                    While pursuing our frontline goal of providing reliable and responsible
                                    spirit. In order to continue this track of advancement Avant Pharma
                                    never loses its sight from the day to day training and capacity
                                    building of our R&D staff. With the best R&D resources, we
                                    ensure our capability to deal with all kind of future challenges
