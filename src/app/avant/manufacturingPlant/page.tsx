                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-6 md:gap-10">
                        ...
                        <div className="w-full md:w-[90%] lg:w-[450px] relative h-64 sm:h-80 md:h-96 rounded-lg overflow-hidden">
                            <Image
                                ...
                                alt="Avant Pharma Manufacturing Plant"
                                width={500}
                                height={600}
                        ...
                        <div className="w-full lg:w-[600px] mt-6 lg:mt-0">
                            ...
                            <div className="text-gray-600 space-y-4 text-sm sm:text-base">
                                <p>
                                    ...
                                    cGMP / Cglp compliant and well equipped including following manufacturing
                                    facilities.
                                </p>
                                <ul className="space-y-2 pl-5 list-disc">
                                    <li>General Tablets Section</li>
                                    <li>General Capsules Section</li>
                                    <li>Liquid Section</li>
                                    <li>General Antibiotic Section</li>
                                </ul>
                            </div>
                        </div>
                    </div>
